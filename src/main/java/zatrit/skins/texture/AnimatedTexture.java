...
/**
 * An optimized version of OpenMCSkins <a
 * href="https://github.com/zatrit/openmcskins/blob/main/src/main/java/net/zatrit/openmcskins/render/textures/AnimatedTexture.java">AnimatedTexture</a>.
 */
  ...
  */
  ...
  public void load(ResourceManager manager) {
    ...
    for (int i = 0; i < this.framesCount; i++) {
      TextureUtil.prepareImage(this.ids[i], this.image.getWidth(), frameHeight);

      this.image.upload(
          0, 0, 0, 0, frameHeight * i, this.image.getWidth(), frameHeight, false, false);
    }
  }
