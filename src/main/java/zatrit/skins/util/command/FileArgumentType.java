...
/**
 * An argument type that allows access to mod resources and files in the mod folder.
 *
 * @see FileProvider
...
public class FileArgumentType implements ArgumentType<Path> {
  private static final SimpleCommandExceptionType NO_PRESET_EXCEPTION =
      new SimpleCommandExceptionType(Text.translatable("openmcskins.command.noPreset"));
  ...
  @Override
  public Path parse(@NotNull StringReader reader) throws CommandSyntaxException {
  ...
  /** Searches for all available files and stores them in {@link #files} */
  public void refresh() {
    this.files.clear();
